/**
* File Name:        ParameciumLN.java
* Purpose:          class blueprint for ParameciumLN objects
...
public class ParameciumLN {
    ...
    */
    public ParameciumLN(String name, String sound, int age) {
        this.name = name;
        this.sound = sound;
    ...
    */
    public String toString() {
        return "I am a Paramecium, a unicellular ciliated protozoan,"
                + " and my name is " + name + "." 
