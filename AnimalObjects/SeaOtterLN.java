/**
* File Name:        SeaOtterLN.java
* Purpose:          class blueprint for SeaOtterLN objects
...
public class SeaOtterLN {
    ...
    */
    public SeaOtterLN(String name, String sound, int age) {
        this.name = name;
        this.sound = sound;
    ...
    */
    public String toString() {
        return "I am a Sea Otter and my name is "
                + name + "." + "I am " + age 
                + " years old and I say " + sound + ".";
    }
